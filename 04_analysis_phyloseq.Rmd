...
```{r}
ord <-plot_ordination(ps.prop, ord.pcoa.bray, color="Rendement", shape = "Genus", title="Bray PCoA")
```
...
plot_bar(ps.top20, x="Rendement", fill="Phylum", title="Diversité des Phyla les plus abondants") + facet_wrap(~Rendement, scales="free_x")
```
